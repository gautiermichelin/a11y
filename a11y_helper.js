...
function activateAccessibilityFunctions() {
    ...
    html.toggleClass('font-readable', Cookies.get('readablefont') === 'yes');
    html.toggleClass('link-underline', Cookies.get('underline') === 'yes');
    ...
    if (cookieFont) {
        ...
        if (!html.hasClass('fsize' + fsCount)) {
            html.addClass('fsize' + fsCount);
        }
    } else {
        html.removeClass('fsize70 fsize80 fsize90 fsize100 fsize110 fsize120 fsize130');
    }

    font_larger.click(function(event) {
        event.preventDefault();
        if (fsCount < 130) {
            html.removeClass('fsize' + fsCount);
            fsCount = fsCount + 10;
            html.addClass('fsize' + fsCount);
    ...
    font_normal.click(function(event) {
        event.preventDefault();
        fsCount = 100;
        html.removeClass('fsize70 fsize80 fsize90 fsize100 fsize110 fsize120 fsize130 font-readable link-underline');
    ...
    ReadableFontButton.click(function(event) {
        ...
        if (!html.hasClass('font-readable')) {
    ...
    link_underline.click(function(event) {
        ...
        if (!html.hasClass('link-underline')) {
            html.addClass('link-underline');
        }
    });
	accessibility_button.click(function(event) {
		console.log('click accessibility_button');
		html.toggleClass('accessibility-menu-open');
	});

    reset_all.click(function() {
        html.removeClass('fsize70 fsize80 fsize90 fsize100 fsize110 fsize120 fsize130 font-readable link-underline fontfamily_inter fontfamily_andika fontfamily_fsme fontfamily_tiresias fontfamily_opendyslexic');
        fsCount = 100;
        Cookies.remove('lab-font-size', { path: cookie_path.cookiePath });
        Cookies.remove('readablefont', { path: cookie_path.cookiePath });
        Cookies.remove('underline', { path: cookie_path.cookiePath });
    ...
    html.addClass(Cookies.get('fontfamily'));
